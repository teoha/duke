...
public class Ui {
    ...
    /**
     * Prints message about the task and the size of task list after a
     * task is added into the list.
    ...
    /**
     * Prints the error message when file containing saved tasks cannot
     * be loaded.
     */
